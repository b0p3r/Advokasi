 ...
 * @author     Iyan Kushardiansah <iyank4@yahoo.com>
 * @package    Ushahidi - http://source.ushahididev.com
 * @copyright  Ushahidi - http://www.ushahidi.com
 * @license    http://www.gnu.org/copyleft/lesser.html GNU Lesser General Public License (LGPL)
 */
class Justmap_Controller extends Template_Controller {
    /**
    ...
    public function __construct()
    {
        ...
        // Load Header & Footer
        $this->template->header  = new View('justheader');
        $this->template->footer  = new View('justfooter');
    ...
    {
        $this->template->header->this_page = 'justmap';
        $this->template->content = new View('main/justmap');
